...
//  private static final String SAMPLE_IMAGE_DATABASE = "sample_database.imgdb";
      private static final String SAMPLE_IMAGE_DATABASE = "broad_ar_lobby.imgdb";
  ...
  private boolean setupAugmentedImageDatabase(Config config, Session session) {
    ...
    if (assetManager == null) {
      Log.e(TAG, "Context is null, cannot inititialize image database.");
      return false;
    }
    ...
    if (USE_SINGLE_IMAGE) {
      ...
      augmentedImageDatabase.addImage("blue_sticky.jpg", augmentedImageBitmap);
